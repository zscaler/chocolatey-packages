...
$url64bit = 'https://github.com/zscaler/zscaler-terraformer/releases/download/v2.0.3/zscaler-terraformer_2.0.3_windows_amd64.zip'
$checksum64bit = 'dffbb7d979c21dcd752c4613b98d38f67a145642eed31fc1afbea12e7b9e1157'

# URL and checksum for the 32-bit .zip file
$url32bit = 'https://github.com/zscaler/zscaler-terraformer/releases/download/v2.0.3/zscaler-terraformer_2.0.3_windows_386.zip'
